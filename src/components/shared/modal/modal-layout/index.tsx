...
import { FC, MouseEvent, memo, useCallback, useEffect, useRef, useState } from 'react'
...
const ModalLayout: FC<IModalLayout> = ({
  nonClosing,
  onClose,
  actionsOnClose,
  children,
  ...
  return mounted
    ? createPortal(
        ...
        document.querySelector<HTMLDivElement>('#modal-root') as HTMLDivElement,
      )
    : null
}
